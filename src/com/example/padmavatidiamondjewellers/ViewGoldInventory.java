...
public class ViewGoldInventory extends Activity {
	DBHelper mydbhelper;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_view_gold_inventory);
		Intent in = getIntent();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.action_add:
        	...
        	Intent i=new Intent(this,GoldInventory.class);
    		startActivity(i);
            return true;
		...
		private void view_buy() {
			...
			mydbhelper=new DBHelper(ViewGoldInventory.this, Database.PDJ_DATABASE_NAME, null, Database.PDJ_DATABASE_VERSION);
			mydatabase=mydbhelper.getWritableDatabase();
			Cursor c_count= mydatabase.rawQuery("select * from "+Database.G_TABLE_NAME+" where "+Database.G_OPERATION +" = 'Buy'",null);
			...
			int i=0;
			String col1[]=new String[]{Database.G_DATE,Database.G_OPERATION,Database.G_QTY,Database.G_RATE,
					Database.G_TOTAL,Database.G_STATUS,
					Database.G_BOUGHT_FROM,Database.G_AMT_PAID,Database.G_AMT_PENDING};
			...
			l=(ListView)findViewById(R.id.gold_listView);
			l.setAdapter(new GoldInventoryAdapter(ViewGoldInventory.this,op,date,qty,rate,total,status,count,bought_from,amt_paid,amt_pending));
	    ...
	    public boolean onContextItemSelected(MenuItem item){ 
			...
			mydatabase=mydbhelper.getWritableDatabase();
			String cols[]=new String[]{Database.G_STATUS,Database.G_TOTAL,
					Database.G_AMT_PAID,Database.G_AMT_PENDING,Database.G_KEY};
	    	...
	    	if(item.getTitle()=="Paid/Unpaid"){  
	    		...
	    		if(status.equals("Paid")){
                	...
                	Toast.makeText(ViewGoldInventory.this,"Not enough Capital",Toast.LENGTH_LONG).show();
                	onBackPressed();

	    		}
	    		ContentValues cs=new ContentValues();
	    		cs.put(Database.G_STATUS,status);
	    		cs.put(Database.G_AMT_PAID,amt_paid);
	    		cs.put(Database.G_AMT_PENDING,amt_pending);
	    		
	    		mydatabase.update(Database.G_TABLE_NAME,cs,Database.G_KEY+"='"+g_bill_no+"'",null);
	    		onCreate(null);
	    		
	            }    
	            else if(item.getTitle()=="Partially Paid"){  
	                if(status.equals("Unpaid") || status.equals("Partially Paid")){
	                	AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ViewGoldInventory.this);
	            		...
	            		alertDialogBuilder.setPositiveButton("Ok",new DialogInterface.OnClickListener() {
	            	        ...
	            	        public void onClick(DialogInterface arg0, int arg1) {
	                            ...
	                            if(amt_pending1<0){
	                            	Toast.makeText(ViewGoldInventory.this,"Cannot Proceed",Toast.LENGTH_SHORT).show();
	                            }else{
	                        		if(amt_pending1==0){
	                            		statu="Paid";
	                            		amt_paid1=total1;
	                        		...
	                        		ContentValues cs=new ContentValues();
	                	    		cs.put(Database.G_STATUS,statu);
	                	    		cs.put(Database.G_AMT_PAID,amt_paid1);
	                	    		cs.put(Database.G_AMT_PENDING,amt_pending1);
    	    		...
    	    		mydatabase.delete(Database.G_TABLE_NAME,Database.G_KEY+"='"+g_bill_no+"'",null);
