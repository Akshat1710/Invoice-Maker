...
public class SilverAdapter extends BaseAdapter {
	...
	int c;
	public SilverAdapter(Context con,String op[],String date[],String qty[] ,
	...
	public View getView(int p, View v, ViewGroup arg2) {
		...
		View r;       
        r = inflater.inflate(R.layout.silver_inventory_inflate, null);
		opt=(TextView)r.findViewById(R.id.view_si_operation);
		datet=(TextView)r.findViewById(R.id.view_si_date);
		qtyt=(TextView)r.findViewById(R.id.view_si_qty);
		ratet=(TextView)r.findViewById(R.id.view_si_rate);
		totalt=(TextView)r.findViewById(R.id.view_si_total);
		statust=(TextView)r.findViewById(R.id.view_si_status);
		bft=(TextView)r.findViewById(R.id.view_bought_from_si);
		apt=(TextView)r.findViewById(R.id.view_si_amt_pending);
